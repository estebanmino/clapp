...
public class VolleyDeleteFavouriteLesson {

    public static void volleyDeleteFavouriteLesson(final VolleyStringCallback callback,
                                          Context context,
                                          String lesson_id) {
        ...
        String url = Constants.BASE_URL + "/" + Constants.COMPANIES + "/" + company_id + "/" + Constants.FAVOURITES + "/" + lesson_id;
