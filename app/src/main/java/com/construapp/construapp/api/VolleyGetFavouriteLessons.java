...
/**
 * Created by ESTEBANFML on 06-11-2017.
 */

public class VolleyGetFavouriteLessons {

    public static void volleyGetFavouriteLessons(final VolleyStringCallback callback,
                                        Context context) {
        ...
        final String url = Constants.BASE_URL + "/" + Constants.COMPANIES + "/" + companyId + "/" + Constants.FAVOURITES;
