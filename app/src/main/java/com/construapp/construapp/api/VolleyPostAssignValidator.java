...
/**
 * Created by ESTEBANFML on 02-11-2017.
 */

public class VolleyPostAssignValidator {

    public static void volleyPostSendValidationLesson(final VolleyStringCallback callback,
                                                      Context context, String lesson_id, String user_id) {
        ...
        String url = Constants.BASE_URL + "/" + Constants.COMPANIES + "/" + company_id + "/" +
                Constants.LESSONS + "/" + lesson_id + "/" + Constants.ASSIGN_VALIDATOR;
