...
public class VolleyPutLessonComment {

    public static void volleyPutLessonComment(final VolleyJSONCallback callback,
                                       Context context, String lesson_id, String comment_id, String comment) {
